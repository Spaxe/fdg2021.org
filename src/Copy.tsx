...
*Chaired by Neil Randall — University of Waterloo, Canada*
...
*Chaired by Maria Törhönen — University of Tampere, Finland*

This track focuses on the emerging trends of esports and streaming from a humanities-informed perspective. Submissions are encouraged from scholars analysing esports and streaming practices and trends. Such work includes studies of demographic trends in esports and streaming, feminist and gender studies perspectives, social-cultural critiques and analyses of streaming and eSports subcultures, examination of societal and economic impact of eSports.

## Game Analytics and Visualization 
*Chaired by Keith Nesbitt — Newcastle University, Australia*
...
*Chaired by Victoria McArthur — Carleton University, Canada*
...
*Chaired by Elín Carstensdóttir — UCSC, USA*
...
Concise workshop proposals (2-4 pages, excluding references, in the [ACM SIGCONF version of the ACM Master Template](https://www.acm.org/publications/proceedings-template)​) should include: a background sections explaining and motivating the workshop, the objectives of the workshop, planned activities, the background of the organizer(s), publication plans (if any), anticipated number of participants, and the means for soliciting and selecting participants. Workshop proposals will not be included in the conference proceedings.

# PANEL PROPOSALS
*Chaired by Laura Levy — Georgia Institute of Technology, USA & Henrik Warpefelt — Södertörn University, Sweden*
...
To apply, students should submit a non-anonymized 2-4 page paper (excluding references) in the [ACM SIGCONF version of the ACM Master Template](https://www.acm.org/publications/proceedings-template)​ describing their proposed research. The paper should address the goals of their research, the proposed approach, any results, and plans for completing the work. This should be accompanied by their CV and a short letter explaining how they would benefit from the consortium and what questions they want to discuss (general and/or specific to their research).
...
Allan Fowler — Game User Research, New Zealand 
